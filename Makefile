...
asm: main_commented.s functions_commented.s functions_max_registers_use.s main_03.s functions_O3.s main_0s.s functions_Os.s
...
test: executable_default executable_commented executable_max_registers_use executable_O3 executable_Os
	...
	./executable_default < input
	./executable_default -r 5
	./executable_default -f input:output
	cat output
	echo "executable_commented"
	./executable_commented < input
	./executable_commented -r 5
	./executable_commented -f input:output
	cat output
	echo "executable_max_registers_use"
	./executable_max_registers_use < input
	./executable_max_registers_use -r 5
	./executable_max_registers_use -f input:output
	cat output
	echo "executable_O3"
	./executable_O3 < input
	./executable_O3 -r 5
	./executable_O3 -f input:output
	cat output
	echo "executable_Os"
	./executable_Os < input
	./executable_Os -r 5
	./executable_Os -f input:output
	cat output